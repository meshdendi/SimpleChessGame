...
public class Horse implements Piece {
	...
	public Horse(JPanel panel, Color team) {
		this.panel = panel;
		this.team = team;
		
		if(this.isWhite()){
			this.icon = new ImageIcon("W:\\Game Projects\\Chess\\src\\images\\white-horse.png");
		}else{
			this.icon = new ImageIcon("W:\\Game Projects\\Chess\\src\\images\\black-horse.png");
		}
