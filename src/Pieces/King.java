...
public class King implements Piece{
	...
	public King(JPanel panel, Color team){
		this.panel = panel;
		this.team = team;
		
		if(this.isWhite()){
			this.icon = new ImageIcon("W:\\Game Projects\\Chess\\src\\images\\white-king.png");
		}else{
			this.icon = new ImageIcon("W:\\Game Projects\\Chess\\src\\images\\black-king.png");
		}
